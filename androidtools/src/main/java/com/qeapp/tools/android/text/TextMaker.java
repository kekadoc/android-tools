package com.qeapp.tools.android.text;
...
import com.qeapp.tools.android.view.size.SizeValue;
import com.qeapp.tools.android.view.size.Sizing;
import com.qeapp.tools.exeption.NotImplementedExeption;
    ...
    public static CharSequence createIconText(@NonNull Context context, @Nullable Drawable icon,
        ...
        switch (iconSize) {
            case Sizing.SIZE_EXTRA_SMALL:
                padding = (int) QeAndroid.dpToPx(context, 2);
                size = (int) QeAndroid.getDimension(context, R.dimen.size_icon_extra_small);
                break;
            case Sizing.SIZE_SMALL:
                padding = (int) QeAndroid.dpToPx(context, 4);
                size = (int) QeAndroid.getDimension(context, R.dimen.size_icon_small);
                break;
            case Sizing.SIZE_MEDIUM:
                padding = (int) QeAndroid.dpToPx(context, 6);
                size = (int) QeAndroid.getDimension(context, R.dimen.size_icon_medium);
                break;
            case Sizing.SIZE_LARGE:
                padding = (int) QeAndroid.dpToPx(context, 8);
                size = (int) QeAndroid.getDimension(context, R.dimen.size_icon_large);
                break;
            case Sizing.SIZE_EXTRA_LARGE:
                padding = (int) QeAndroid.dpToPx(context, 10);
                size = (int) QeAndroid.getDimension(context, R.dimen.size_icon_extra_large);
                break;
            default: throw new NotImplementedExeption();
        }
    ...
    public static CharSequence createIconText(@NonNull Context context, @Nullable Drawable icon, @SizeValue int iconSize, CharSequence text) {
        ...
        switch (iconSize) {
            ...
            case Sizing.SIZE_LARGE:
                ...
                break;
            case Sizing.SIZE_EXTRA_LARGE:
                padding = (int) QeAndroid.dpToPx(context, 12);
                size = (int) QeAndroid.getDimension(context, R.dimen.size_icon_extra_large);
                break;
            default: throw new NotImplementedExeption();
        }
